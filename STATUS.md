...
The authors apply for the following ACM Artifact Evaluation badges:
...
The artifact is archived in a persistent public repository with an assigned DOI. The archived version corresponds to the version used to produce the experimental results reported in the accompanying paper.

## Functional

The artifact contains all notebooks, scripts, and supporting files required to reproduce the experiments presented in the paper. Installation instructions, software requirements, and example workflows are provided in the accompanying documentation. Following the documented steps allows reviewers to execute the experiments and reproduce the reported results.
